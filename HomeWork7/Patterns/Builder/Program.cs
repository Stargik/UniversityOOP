...
namespace Builder
{
    class Program
    {
        ...
        {
            public override void BuildDough() { pizza.SetDough("standard"); }
            public override void BuildSauce() { pizza.SetSauce("gentle"); }
        ...
        class BuilderExample
        {
            public static void Main(String[] args)
            {
                ...
                PizzaBuilder margaritaPizzaBuider = new MargaritaPizzaBuilder();
                ...
                waiter.SetPizzaBuilder(margaritaPizzaBuider);
                waiter.ConstructPizza();
